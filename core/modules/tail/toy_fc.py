...
class ToyFC(Module):
    ...
    @torch.no_grad()
    def __init__(self, rank, local_rank, world_size, batch_size,
    ...
    def prepare(self, label, optimizer):
        ...
        with torch.cuda.stream(self.stream):
            ...
            optimizer.param_groups[-1]['params'][0] = self.weight
            optimizer.state[self.weight]['momentum_buffer'] = self.weight_mom
